...
class SEVIRGenerator():
    """
    Class for creating training and testing dataset from SEVIR.  This class can be used directly for streaming data into
    ...
    x_img_types  list 
        List of image types to be used as model inputs.  For types, run SEVIRGenerator.get_types()
    ...
    --------
        ...
        vil_imgs = SEVIRGenerator(x_img_types=['vil'], batch_size=256, unwrap_time=True, shuffle=True)
